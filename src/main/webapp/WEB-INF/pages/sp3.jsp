                ...
                <div class="col-md-8 col-sm-offset-2 personal-info">
                    ...
                    <form action="sp1" method="post" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input name="firstName" class="form-control" type="text" value="Samuel">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input name="lastName" class="form-control" type="text" value="Martinez">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input name="middleInitial" class="form-control" type="text" value="B">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input name="emailAddress" class="form-control" type="text" value="sp3@gmail.com">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input name="phoneNumber" class="form-control" type="text" value="09171234556">
                            </div>
                        </div>
