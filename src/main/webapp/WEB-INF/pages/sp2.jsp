                ...
                <div class="col-md-8 col-sm-offset-2 personal-info">
                    ...
                    <form action="sp1" method="post" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input name="firstName" class="form-control" type="text" value="Marko">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input name="lastName" class="form-control" type="text" value="Prada">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input name="middleInitial" class="form-control" type="text" value="C">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input name="emailAddress" class="form-control" type="text" value="sp2@gmail.com">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input name="phoneNumber" class="form-control" type="text" value="09171234513">
                            </div>
                        </div>
